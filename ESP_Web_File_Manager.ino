...
void handleRoot() {
  if (LittleFS.exists("/index.html")) {
    ...
    server.send(302, "text/plain", "Redirect to /main");
  } else {
    String redirectPage = "<html><body style='text-align:center;'>";
    redirectPage += "<p>Cant find index.html</p>";
    redirectPage += "<p>Please upload a index.html and style.css</p>";
